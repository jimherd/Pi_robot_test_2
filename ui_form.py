...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QRect(415, 0, 921, 726))
        ...
        self.layoutWidget1.setGeometry(QRect(15, 0, 761, 313))
        font2 = QFont()
        font2.setBold(False)
...
"color: rgb(255, 255, 0)")
        ...
        self.layoutWidget_2.setGeometry(QRect(15, 300, 759, 386))
...
"color: rgb(255, 255, 0)")
        ...
        self.display_control = QWidget()
        self.display_control.setObjectName(u"display_control")
        self.groupBox = QGroupBox(self.display_control)
        self.groupBox.setObjectName(u"groupBox")
        self.groupBox.setGeometry(QRect(60, 35, 541, 106))
        self.groupBox.setFont(font)
        self.groupBox.setFlat(True)
        self.label_12 = QLabel(self.groupBox)
        self.label_12.setObjectName(u"label_12")
        self.label_12.setGeometry(QRect(35, 35, 131, 51))
        font8 = QFont()
        font8.setPointSize(15)
        self.label_12.setFont(font8)
        self.spinBox_2 = QSpinBox(self.groupBox)
        self.spinBox_2.setObjectName(u"spinBox_2")
        self.spinBox_2.setGeometry(QRect(180, 45, 56, 36))
        font9 = QFont()
        ...
        self.pushButton_3.setGeometry(QRect(255, 40, 146, 56))
        self.pushButton_3.setFont(font9)
        self.pushButton_3.setCheckable(False)
        self.groupBox_2 = QGroupBox(self.display_control)
        self.groupBox_2.setObjectName(u"groupBox_2")
        self.groupBox_2.setGeometry(QRect(50, 175, 596, 166))
        self.groupBox_2.setFont(font)
        self.label_14 = QLabel(self.groupBox_2)
        self.label_14.setObjectName(u"label_14")
        self.label_14.setGeometry(QRect(50, 35, 146, 41))
        self.label_14.setFont(font8)
        self.spinBox_3 = QSpinBox(self.groupBox_2)
        self.spinBox_3.setObjectName(u"spinBox_3")
        self.spinBox_3.setGeometry(QRect(210, 40, 51, 31))
        self.spinBox_3.setFont(font9)
        self.spinBox_3.setMaximum(6)
        self.pushButton_4 = QPushButton(self.groupBox_2)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setGeometry(QRect(285, 30, 196, 56))
        self.pushButton_4.setFont(font9)
        self.textEdit = QTextEdit(self.groupBox_2)
        self.textEdit.setObjectName(u"textEdit")
        self.textEdit.setGeometry(QRect(175, 100, 281, 36))
        self.label_18 = QLabel(self.groupBox_2)
        self.label_18.setObjectName(u"label_18")
        self.label_18.setGeometry(QRect(20, 90, 136, 46))
        self.label_18.setFont(font8)
        self.groupBox_3 = QGroupBox(self.display_control)
        self.groupBox_3.setObjectName(u"groupBox_3")
        self.groupBox_3.setGeometry(QRect(50, 355, 526, 176))
        self.groupBox_3.setFont(font)
        self.pushButton_5 = QPushButton(self.groupBox_3)
        self.pushButton_5.setObjectName(u"pushButton_5")
        self.pushButton_5.setGeometry(QRect(285, 55, 156, 56))
        self.pushButton_5.setFont(font9)
        self.spinBox_4 = QSpinBox(self.groupBox_3)
        self.spinBox_4.setObjectName(u"spinBox_4")
        self.spinBox_4.setGeometry(QRect(195, 65, 66, 31))
        self.spinBox_4.setFont(font9)
        self.spinBox_4.setMaximum(6)
        self.label_20 = QLabel(self.groupBox_3)
        self.label_20.setObjectName(u"label_20")
        self.label_20.setGeometry(QRect(25, 60, 181, 41))
        self.label_20.setFont(font8)
        self.radioButton_1 = QRadioButton(self.groupBox_3)
        self.radioButton_1.setObjectName(u"radioButton_1")
        self.radioButton_1.setGeometry(QRect(85, 125, 110, 24))
        self.radioButton_2 = QRadioButton(self.groupBox_3)
        self.radioButton_2.setObjectName(u"radioButton_2")
        self.radioButton_2.setGeometry(QRect(285, 125, 146, 31))
        self.tabWidget.addTab(self.display_control, "")
        self.groupBox_3.raise_()
        self.groupBox_2.raise_()
        self.groupBox.raise_()
        self.Display_4D = QWidget()
        self.Display_4D.setObjectName(u"Display_4D")
        self.spinBox_5 = QSpinBox(self.Display_4D)
        self.spinBox_5.setObjectName(u"spinBox_5")
        self.spinBox_5.setGeometry(QRect(140, 150, 91, 36))
        self.spinBox_5.setFont(font9)
        self.spinBox_5.setMaximum(6)
        self.pushButton_6 = QPushButton(self.Display_4D)
        self.pushButton_6.setObjectName(u"pushButton_6")
        self.pushButton_6.setGeometry(QRect(280, 145, 181, 46))
        self.pushButton_6.setFont(font)
        self.label_23 = QLabel(self.Display_4D)
        self.label_23.setObjectName(u"label_23")
        self.label_23.setGeometry(QRect(105, 115, 161, 26))
        self.label_23.setFont(font)
        self.tabWidget.addTab(self.Display_4D, "")
        self.widget_2 = QWidget(self.centralwidget)
        self.widget_2.setObjectName(u"widget_2")
        self.widget_2.setGeometry(QRect(20, 15, 401, 406))
        self.label_9 = QLabel(self.widget_2)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(20, 15, 101, 26))
        self.label_9.setFont(font)
        self.info_textEdit = QTextEdit(self.widget_2)
        self.info_textEdit.setObjectName(u"info_textEdit")
        self.info_textEdit.setGeometry(QRect(15, 50, 371, 301))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("MainWindow", u"Display 4D page", None))
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Page index", None))
        self.pushButton_3.setText(QCoreApplication.translate("MainWindow", u"Load page", None))
        self.groupBox_2.setTitle(QCoreApplication.translate("MainWindow", u"Display 4D string", None))
        self.label_14.setText(QCoreApplication.translate("MainWindow", u"String index", None))
        self.pushButton_4.setText(QCoreApplication.translate("MainWindow", u"Load new string", None))
        self.label_18.setText(QCoreApplication.translate("MainWindow", u"New string", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("MainWindow", u"Display 4D button", None))
        self.pushButton_5.setText(QCoreApplication.translate("MainWindow", u"Read Button", None))
        self.label_20.setText(QCoreApplication.translate("MainWindow", u"Button index", None))
        self.radioButton_1.setText(QCoreApplication.translate("MainWindow", u"Pressed", None))
        self.radioButton_2.setText(QCoreApplication.translate("MainWindow", u"Not pressed", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.display_control), QCoreApplication.translate("MainWindow", u"4D Display", None))
        self.pushButton_6.setText(QCoreApplication.translate("MainWindow", u"Run sequence", None))
        self.label_23.setText(QCoreApplication.translate("MainWindow", u"Sequence number", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.Display_4D), QCoreApplication.translate("MainWindow", u"Sequences", None))
